...
- docs - All relevant documentation should go here
...
Mostly resides under 'docs/' folder.

docs/internal - is internal reference only.

docs/user - User manual, software developers manual etc. Released externally
