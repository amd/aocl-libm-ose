...
int test_cos(void* handle) {
    ...
    funcf     s1f = (funcf)dlsym(handle, "amd_cosf");
    func      s1d = (func)dlsym(handle, "amd_cos");
    func_v2d  v2d = (func_v2d)dlsym(handle, "amd_vrd2_cos");
    func_v4d  v4d = (func_v4d)dlsym(handle, "amd_vrd4_cos");
    funcf_v4s v4s = (funcf_v4s)dlsym(handle, "amd_vrs4_cosf");
    funcf_v8s v8s = (funcf_v8s)dlsym(handle, "amd_vrs8_cosf");
    funcf_va  vas = (funcf_va)dlsym(handle, "amd_vrsa_cosf");
    func_va   vad = (func_va)dlsym(handle, "amd_vrda_cos");
