...
int test_cos(void* handle) {
    ...
    //array vector
    void (*lamd_vrda_cos) (int, double*, double*);
    void (*lamd_vrsa_cosf) (int, float* , float*);
    ...
    lamd_vrsa_cosf = dlsym(handle, "amd_vrsa_cosf");
    lamd_vrda_cos  = dlsym(handle, "amd_vrda_cos");
