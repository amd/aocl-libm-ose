...
int test_cosh(void* handle) {
    ...
    float (*funcf)(float) = (float (*)(float))dlsym(handle, "amd_coshf");
    double (*func)(double) = (double (*)(double))dlsym(handle, "amd_cosh");
    __m128 (*funcf_v4s)(__m128) = (__m128 (*)(__m128))dlsym(handle, "amd_vrs4_coshf");
    __m256 (*funcf_v8s)(__m256) = (__m256 (*)(__m256))dlsym(handle, "amd_vrs8_coshf");
