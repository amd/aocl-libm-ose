...
int test_cosh(void* handle) {
    ...
    funcf     s1f = (funcf)dlsym(handle, "amd_coshf");
    func      s1d = (func)dlsym(handle, "amd_cosh");
    funcf_v4s v4s = (funcf_v4s)dlsym(handle, "amd_vrs4_coshf");
    funcf_v8s v8s = (funcf_v8s)dlsym(handle, "amd_vrs8_coshf");
