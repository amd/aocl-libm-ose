...
int test_exp(void* handle) {
    ...
    func_v2d  v2d = (func_v2d)dlsym(handle, "amd_vrd2_exp");
    func_v4d  v4d = (func_v4d)dlsym(handle, "amd_vrd4_exp");
    funcf_v4s v4s = (funcf_v4s)dlsym(handle, "amd_vrs4_expf");
    funcf_v8s v8s = (funcf_v8s)dlsym(handle, "amd_vrs8_expf");
    funcf_va  vas = (funcf_va)dlsym(handle, "amd_vrsa_expf");
    func_va   vad = (func_va)dlsym(handle, "amd_vrda_exp");
    /*avx512*/
    #if defined(__AVX512__)
    func_v8d  v8d = (func_v8d)dlsym(handle, "amd_vrd8_exp");
    func_v16s v16s = (func_v16s)dlsym(handle, "amd_vrs16_expf");
    #endif
