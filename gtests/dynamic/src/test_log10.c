...
int test_log10(void* handle) {
    ...
    float (*lamd_log10f)(float);
    double (*lamd_log10)(double);
    __m128d (*lamd_vrd2_log10)  (__m128d);
    __m128  (*lamd_vrs4_log10f) (__m128);
    //__m256d (*lamd_vrd4_log10)  (__m256d);
    //__m256  (*lamd_vrs8_log10f) (__m256);

    //array vector
    void (*lamd_vrda_log10) (int, double*, double*);
    void (*lamd_vrsa_log10f) (int, float* , float*);
    ...
    /*scalar routines*/
    lamd_log10f = dlsym(handle, "amd_log10f");
    lamd_log10  = dlsym(handle, "amd_log10");
    /*vector routines*/
    lamd_vrd2_log10  = dlsym(handle, "amd_vrd2_log10");
    lamd_vrs4_log10f = dlsym(handle, "amd_vrs4_log10f");
    //lamd_vrd4_log10  = dlsym(handle, "amd_vrd4_log10");
    //lamd_vrs8_log10f = dlsym(handle, "amd_vrs8_log10f");
    //vector array variants
    lamd_vrsa_log10f = dlsym(handle, "amd_vrsa_log10f");
    lamd_vrda_log10  = dlsym(handle, "amd_vrda_log10");
    ...
    printf("Exercilog10g log10 routines\n");
    /*scalar*/
    outputf = (*lamd_log10f)(inputf);
    printf("amd_log10f(%f) = %f\n", inputf, outputf);
    output = (*lamd_log10)(input);
    printf("amd_log10(%lf) = %lf\n", input, output);

    /*vrd2*/
    op_vrd2 = (*lamd_vrd2_log10)(ip_vrd2);
    ...
    /*vrs4*/
    op_vrs4 = (*lamd_vrs4_log10f)(ip_vrs4);
    ...
    /*vrd4*/
    /*
    op_vrd4 = (*lamd_vrd4_log10)(ip_vrd4);
    _mm256_storeu_pd(output_array_vrd4, op_vrd4);
    printf("amd_vrd4_log10([%lf,%lf,%lf,%lf]) = [%lf,%lf,%lf,%lf])\n",
    ...
    */
    /*vrs8*/
    /*
    op_vrs8 = (*lamd_vrs8_log10f)(ip_vrs8);
    ...
    */
    ...
    for (unsigned int i = 0; i < loopCount; i++) {
        (*lamd_vrsa_log10f)(dim, input_arrayf + i*dim, output_arrayf + i*dim);
    }
    printf("\nOutput:\n");
    for (unsigned int i = 0; i < array_size; i++) {
    ...
    for (unsigned int i = 0; i < loopCount; i++) {
        (*lamd_vrda_log10)(dim, input_arrayd + i*dim, output_arrayd + i*dim);
    }
