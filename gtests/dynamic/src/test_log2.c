...
int test_log2(void* handle) {
    ...
    float (*funcf)(float) = (float (*)(float))dlsym(handle, "amd_log2f");
    double (*func)(double) = (double (*)(double))dlsym(handle, "amd_log2");
    __m128d (*func_v2d)(__m128d) = (__m128d (*)(__m128d))dlsym(handle, "amd_vrd2_log2");
    __m128 (*funcf_v4s)(__m128) = (__m128 (*)(__m128))dlsym(handle, "amd_vrs4_log2f");
    void (*funcf_va)(int, float*, float*) = (void (*)(int, float*, float*))dlsym(handle, "amd_vrsa_log2f");
    void (*func_va)(int, double*, double*) = (void (*)(int, double*, double*))dlsym(handle, "amd_vrda_log2f");
