...
int test_log10(void* handle) {
    ...
    /* update all the existing variants here */
     struct FuncData data = {
            ...
            .s1f = (funcf)GetProcAddress(handle, "amd_log10f"),
            .s1d = (func)GetProcAddress(handle, "amd_log10"),
            .v2d = (func_v2d)GetProcAddress(handle, "amd_vrd2_log10"),
            .v4s = (funcf_v4s)GetProcAddress(handle, "amd_vrs4_log10f"),
            .v8s = (funcf_v8s)GetProcAddress(handle, "amd_vrs8_log10f"),
            .vas = (funcf_va)GetProcAddress(handle, "amd_vrsa_log10f"),
            .vad = (func_va)GetProcAddress(handle, "amd_vrda_log10"),
        #else
