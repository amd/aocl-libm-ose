...
int test_log2(void* handle) {
    ...
    /* update all the existing variants here */
     struct FuncData data = {
            ...
            .s1f = (funcf)GetProcAddress(handle, "amd_log2f"),
            .s1d = (func)GetProcAddress(handle, "amd_log2"),
            .v2d = (func_v2d)GetProcAddress(handle, "amd_vrd2_log2"),
            .v4d = (func_v4d)GetProcAddress(handle, "amd_vrd4_log2"),
            .v4s = (funcf_v4s)GetProcAddress(handle, "amd_vrs4_log2f"),
            .v8s = (funcf_v8s)GetProcAddress(handle, "amd_vrs8_log2f"),
            .vas = (funcf_va)GetProcAddress(handle, "amd_vrsa_log2f"),
            .vad = (func_va)GetProcAddress(handle, "amd_vrda_log2"),
        #else
