...
int test_pow(void* handle) {
    ...
    struct FuncData data = {
            ...
            .s1f_2 = (funcf_2)GetProcAddress(handle, "amd_powf"),
            .s1d_2 = (func_2)GetProcAddress(handle, "amd_pow"),
            .v2d_2 = (func_v2d_2)GetProcAddress(handle, "amd_vrd2_pow"),
            .v4d_2 = (func_v4d_2)GetProcAddress(handle, "amd_vrd4_pow"),
            .v4s_2 = (funcf_v4s_2)GetProcAddress(handle, "amd_vrs4_powf"),
            .v8s_2 = (funcf_v8s_2)GetProcAddress(handle, "amd_vrs8_powf"),
            .vas_2 = (funcf_va_2)GetProcAddress(handle, "amd_vrsa_powf"),
        #else
