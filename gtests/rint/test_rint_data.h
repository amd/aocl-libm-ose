...
test_rintf_conformance_data[] = {
   ...
   {0x38800000, 0x3f800000,  0},  //min= 0.00006103515625, small enough that rint(x) = 1
   ...
   {0x42B2D4FC, 0x7f7fffec,  0}, //max arg, x = 89.41598629223294,max rintf arg
...
test_rint_conformance_data[] = {
    ...
    {0x408633ce8fb9f87eLL, 0x7ff0000000000000LL, FE_OVERFLOW}, //max arg, x = 89.41598629223294,max rintf arg
