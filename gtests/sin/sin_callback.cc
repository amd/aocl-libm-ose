...
void SpecSetupf32(SpecParams *specp) {
  specp->data32 = test_sinf_special_data;
  specp->countf = ARRAY_SIZE(test_sinf_special_data); 
}

void SpecSetupf64(SpecParams *specp) {
  specp->data64 = test_sin_special_data;
  specp->countd = ARRAY_SIZE(test_sin_special_data); 
}
