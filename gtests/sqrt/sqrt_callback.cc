...
void SpecSetupf32(SpecParams *specp) {
  specp->data32 = test_sqrtf_special_data;
  specp->countf = ARRAY_SIZE(test_sqrtf_special_data); 
}

void SpecSetupf64(SpecParams *specp) {
  specp->data64 = test_sqrt_special_data;
  specp->countd = ARRAY_SIZE(test_sqrt_special_data); 
}
