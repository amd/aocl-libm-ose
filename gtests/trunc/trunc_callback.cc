...
void SpecSetupf32(SpecParams *specp) {
  specp->data32 = test_truncf_special_data;
  specp->countf = ARRAY_SIZE(test_truncf_special_data); 
}

void SpecSetupf64(SpecParams *specp) {
  specp->data64 = test_trunc_special_data;
  specp->countd = ARRAY_SIZE(test_trunc_special_data); 
}
