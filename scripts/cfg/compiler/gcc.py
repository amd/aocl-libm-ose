...
class Compiler:
    def __init__(self, prod_mode):
        ...
        self.link_flag_map = {
            "debug": {link_flags_debug},
            "release": {link_flags_release}
        }

	    self.link_flags_debug = []
	    self.link_flags_release = compile_flags_release

        self.cpp_flag_map = {
            "debug": {cpp_flags_debug},
            "release": {cpp_flags_release}
        }
