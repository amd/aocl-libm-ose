...
; vrsa_log10f.S
;
; An implementation of the vrsa_log10f libm function.
;
; Prototype:
;
;     void vrsa_log10f(int len, float *src,float *dst);
;
;
;   Algorithm:
;
...
FN_PROTOTYPE_BAS64 vrsa_log10f
...
L__vrsa_top:
    ...
    sub rdi, 4
    add r8, 4
    jmp L__start_process_vrs4_log10f
L__fill_single:
