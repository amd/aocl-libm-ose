...
save_xmm10      EQU     0C0h
save_xmm11      EQU     0E0h
save_xmm12      EQU     0100h
save_xmm13      EQU     0120h
save_xmm14      EQU     0140h
save_xmm15      EQU     0160h
stack_size      EQU     0188h  ; We take 8 as the last nibble to allow for 
...
L__start: 
	...
	VANDPD   xmm12	,xmm0  ,  xmm11 ;xmm12 has nan zero and inf values
	VANDNPD  xmm1	,xmm11 ,  xmm11
	VORPD    xmm12	,xmm12,  xmm1 
	
	VANDNPD xmm1    ,xmm3,  xmm12 ;convert nan to qnan	
	...
	VANDNPD xmm0  , xmm6,  xmm3		; pick xmm3 or xmm5   xmm2 or xmm4
	...
	VCVTDQ2PD xmm5,xmm5
	VFNMADD231PD xmm4 ,xmm5,L__one_by_512 ;index_u64   xmm2    f = xmm4
	...
	VFMADD132PD xmm5   ,xmm10, L__coefficients_1 ; z = xmm5 , xmm2 = index_u64256,mf = xmm3
	...
	VFMADD231PD xmm0,xmm6, xmm9	; bH = xmm2 , bT = xmm0
	...
	VANDPD  xmm12,xmm12,xmm11 ; handling of NAN and inf
