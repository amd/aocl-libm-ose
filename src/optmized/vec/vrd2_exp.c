...
static const struct {
    ...
    v_f64x2_t poly[5];
                    ...
                    .tblsz_ln2      = _MM_SET1_PD2(0x1.71547652b82fep10),
                    .ln2_tblsz_head = _MM_SET1_PD2(0x1.62e42f0000000p-11),
                    .ln2_tblsz_tail = _MM_SET1_PD2(0x1.DF473DE6AF279p-36),
                    ...
                    .exp_min        = _MM_SET1_I64x2(-709),
                    .exp_max        = _MM_SET1_I64x2(710),
...
FN_PROTOTYPE_OPT(vrd2_exp)(v_f64x2_t x)
{
    ...
    //      = (C1 + C2*r) + r^2(C3 + C4*r)
    r2 = r * r;
    v_f64x2_t poly = POLY_EVAL_1(r, C1, C2) + r2 * r2 * C3;
