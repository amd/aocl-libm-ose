...
int test_pow(void* handle) {
    ...
    /*scalar routines*/
    *(void **) (&amd_powf) = dlsym(handle, "amd_powf");
    *(void **) (&amd_pow)  = dlsym(handle, "amd_pow");
    /*vector routines*/
    *(void **) (&amd_vrd2_pow)  = dlsym(handle, "amd_vrd2_pow");
    *(void **) (&amd_vrs4_powf) = dlsym(handle, "amd_vrs4_powf");
    *(void **) (&amd_vrd4_pow)  = dlsym(handle, "amd_vrd4_pow");
    *(void **) (&amd_vrs8_powf) = dlsym(handle, "amd_vrs8_powf");
    ...
    /*scalar*/
    outputf = (*amd_powf)(inputf, inputf);
    printf("amd_powf(%f) = %f\n", inputf, outputf);
    output = (*amd_pow)(input, input);
    printf("amd_pow(%lf) = %lf\n", input, output);

    /*vrd2*/
    op_vrd2 = (*amd_vrd2_pow)(ip_vrd2, ip_vrd2);
    ...
    /*vrs4*/
    op_vrs4 = (*amd_vrs4_powf)(ip_vrs4, ip_vrs4);
    ...
    /*vrd4*/
    op_vrd4 = (*amd_vrd4_pow)(ip_vrd4, ip_vrd4);
    ...
    /*vrs8*/
    op_vrs8 = (*amd_vrs8_powf)(ip_vrs8, ip_vrs8);
