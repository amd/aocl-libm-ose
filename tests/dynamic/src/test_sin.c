...
int test_sin(void* handle) {
    ...
    /*scalar routines*/
    *(void **) (&amd_sinf) = dlsym(handle, "amd_sinf");
    *(void **) (&amd_sin)  = dlsym(handle, "amd_sin");
    /*vector routines*/
    *(void **) (&amd_vrd2_sin)  = dlsym(handle, "amd_vrd2_sin");
    *(void **) (&amd_vrs4_sinf) = dlsym(handle, "amd_vrs4_sinf");
    //*(void **) (&amd_vrd4_sin)  = dlsym(handle, "amd_vrd4_sin");
    *(void **) (&amd_vrs8_sinf) = dlsym(handle, "amd_vrs8_sinf");
    ...
    /*scalar*/
    outputf = (*amd_sinf)(inputf);
    printf("amd_sinf(%f) = %f\n", inputf, outputf);
    output = (*amd_sin)(input);
    printf("amd_sin(%lf) = %lf\n", input, output);

    /*vrd2*/
    op_vrd2 = (*amd_vrd2_sin)(ip_vrd2);
