...
int test_tan(void* handle) {
    ...
    /*scalar routines*/
    *(void **) (&amd_tanf) = dlsym(handle, "amd_tanf");
    *(void **) (&amd_tan)  = dlsym(handle, "amd_tan");
    /*vector routines*/
    *(void **) (&amd_vrd2_tan)  = dlsym(handle, "amd_vrd2_tan");
    *(void **) (&amd_vrs4_tanf) = dlsym(handle, "amd_vrs4_tanf");
    //*(void **) (&amd_vrd4_tan)  = dlsym(handle, "amd_vrd4_tan");
    //*(void **) (&amd_vrs8_tanf) = dlsym(handle, "amd_vrs8_tanf");
    ...
    /*scalar*/
    outputf = (*amd_tanf)(inputf);
    printf("amd_tanf(%f) = %f\n", inputf, outputf);
    output = (*amd_tan)(input);
    printf("amd_tan(%lf) = %lf\n", input, output);

    /*vrd2*/
    op_vrd2 = (*amd_vrd2_tan)(ip_vrd2);
