...
/*
 * Call the glibc's expm1() to get IEEE754 compliant values
 */
...
int test_expm1_verify(struct libm_test *test, struct libm_test_result *result)
{
    ...
    /*
     * Call the glibc's expm12() to get IEEE754 compliant values
     */
...
int test_expm1_alloc_init(struct libm_test_conf *conf, struct libm_test *test)
{
