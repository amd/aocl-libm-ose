...
#if defined(FLOAT)
#define FUNC_REMAINDER am_mp_remainderf
#define FUNC_REMAINDER_ULP am_mp_remainderf_ULP
#elif defined(DOUBLE)
#define FUNC_REMAINDER am_mp_remainder
#define FUNC_REMAINDER_ULP am_mp_remainder_ULP
#else
#error
#endif
