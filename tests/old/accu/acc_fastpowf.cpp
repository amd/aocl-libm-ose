...
#define S_SP_POW powf
#else
#define S_SP_POW powf
//#define S_SP_POW fastpowf
#endif
...
#ifdef WIN64
    // *** - original pow seems to produce wrong results
   {0xbf800000,0xFF800000,0xbF800000},  // ***
   {0x7FC00000,0x00000000,0x7FC00000},  // ***
   {0xfFC00000,0x80000000,0xfFC00000},  // ***

   {0xC1200000,0x3FA00000,0xfFC00000},
   {0xC1200000,0xbFA00000,0xfFC00000},

   {0x402DF854,0xc2cff1b4,0x00000000},  // ***

{0x00000000,0x7f800001,0x7f800001},
{0x80000000,0x7f800001,0x7f800001},

{0xbf800000,0xff800000,0xbf800000},  // ***

{0xbf800000,0x7f800001,0x7f800001},
{0x7f800000,0x7f800001,0x7f800001},
{0xff800000,0x7f800001,0x7f800001},

{0x7fc00000,0x00000000,0x7fc00000},  // ***
{0x7fc00000,0x80000000,0x7fc00000},  // ***
{0x7f800001,0x00000000,0x7f800001},  // ***
{0x7f800001,0x80000000,0x7f800001},  // ***

{0x7f800001,0x3f800000,0x7f800001},
{0x7f800001,0xbf800000,0x7f800001},
{0x7f800001,0x7f800000,0x7f800001},
{0x7f800001,0xff800000,0x7f800001},
{0x7f800001,0x7fc00000,0x7f800001},
{0x7f800001,0x7f800001,0x7f800001},
#else
   {0xbf800000,0xFF800000,0x3F800000},  //-1 ^ -Inf				  = +1
   {0x7FC00000,0x00000000,0x3F800000},  //any x ^ +0 			  = +1	even NaN
   {0xfFC00000,0x80000000,0x3F800000},  //any x ^ -0 			  = +1	even NaN
   ...
   {0x402DF854,0xc2cff1b4,0x00000000},  //e^ -87.3365 smallest denormal
...
extern "C" float S_SP_POW(float, float);
...
void acc_fastpowf()
{
    ...
    for(size_t k=0; k<LENGTH_OF(ACC_TEST_32_01); k++)
    {
        ...
        v_x.u32 = pTest[k].in1;
        v_y.u32 = pTest[k].in2;
        v_z.f32 = S_SP_POW(v_x.f32, v_y.f32);

        bool fail = false;
        if(v_z.u32 != pTest[k].out) fail = true;

        if(fail)
        {
            std::cout << "Failure: " << "(" << std::hex << v_x.u32 << "," << v_y.u32 << ")" << " , Expected: " <<
                pTest[k].out << ", Actual: " << v_z.u32 << std::endl;
