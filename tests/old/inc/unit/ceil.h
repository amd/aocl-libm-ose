//R.obtained=FN_PROTOTYPE(ceil)(P1.input)
...
//double double ExcFlags
//ULP amd_ref_ceil_ULP(P1.V3[j],R.V3[j],&testdata[k].R.ulp[j], &testdata[k].R.relative_error[j])
//testdata[j].R.MaxUlp()
...
static struct data input[] =
{
    ...
    /*Some Common Inputs*/
    {0x3Fe1234ABCDEF123LL,0x3ff0000000000000LL,EXC_CHK_NONE},
    {0xbFe1234ABCDEF123LL,0x8000000000000000LL,EXC_CHK_NONE},
    {0x3FeA234ABCDEF123LL,0x3ff0000000000000LL,EXC_CHK_NONE},
    {0xbFeA234ABCDEF123LL,0x8000000000000000LL,EXC_CHK_NONE},
    {0x3FF1234ABCDEF123LL,0x4000000000000000LL,EXC_CHK_NONE},
    {0xbFF1234ABCDEF123LL,0xbff0000000000000LL,EXC_CHK_NONE},
    {0x3FFA234ABCDEF123LL,0x4000000000000000LL,EXC_CHK_NONE},
    {0xbFFA234ABCDEF123LL,0xbff0000000000000LL,EXC_CHK_NONE},
    {0x400853451234ABCDLL,0x4010000000000000LL,EXC_CHK_NONE},
    ...
    {0x431ABCDEF1234567LL,0x431abcdef1234568LL,EXC_CHK_NONE},
    {0xc31ABCDEF1234567LL,0xc31abcdef1234564LL,EXC_CHK_NONE},
    {0x411ABCDEF1234567LL,0x411abce000000000LL,EXC_CHK_NONE},
    {0xc11ABCDEF1234567LL,0xc11abcdc00000000LL,EXC_CHK_NONE},
    {0x400ABCDEF1234567LL,0x4010000000000000LL,EXC_CHK_NONE},
    {0xc00ABCDEF1234567LL,0xc008000000000000LL,EXC_CHK_NONE},
    {0x4006BCDEF1234567LL,0x4008000000000000LL,EXC_CHK_NONE},
