//R.obtained=FN_PROTOTYPE(ceilf)(P1.input)
//float,float,ExcFlags
//P1 R E
//unsigned int|float, unsigned int|float,ExcFlags|ExcFlags
//R.V3[j] = amd_ref_ceilf(P1.V3[j])
//float float ExcFlags
//ULP amd_ref_ceilf_ULP(P1.V3[j],R.V3[j],&testdata[k].R.ulp[j], &testdata[k].R.relative_error[j])
//testdata[j].R.MaxUlp()
...
static struct data input[] =
{
    ...
    {0x4ab70123,0x4ab70124,EXC_CHK_NONE}, // less than 2^24
    ...
    {0x43ABCDEF,0x43ac0000,EXC_CHK_NONE}, // less than 2^24
