//R.obtained=FN_PROTOTYPE(log2)(P1.input)
...
//double double ExcFlags
//ULP amd_ref_log2_ULP(P1.V3[j],R.V3[j],&testdata[k].R.ulp[j], &testdata[k].R.relative_error[j])
//testdata[j].R.MaxUlp()
...
static struct data input[] =
{
   { F64_POS_SNAN ,      0x7ff8000000000001LL   ,EXC_CHK_INVL},
    ...
    { F64_POS_HDENORM,   0xc08ff00000000000LL  ,EXC_CHK_NONE},
    ...
    { F64_POS_HNORMAL,   0x4090000000000000LL  ,EXC_CHK_NONE},
    ...
    { F64_POS_PIBY2,     0x3fe4d90e7ebf727aLL  ,EXC_CHK_NONE},  //pi/2
   {0x0000000000000000LL,0xfff0000000000000LL,EXC_CHK_ZERO},  //0.0
   {0x3EE0624DD2F1A9FCLL,0xc030f73da38d9d4bLL,EXC_CHK_NONE},  //0.0000078125
   {0x3EF0624DC31C6CA1LL,0xc02fee7b49e50bbdLL,EXC_CHK_NONE},  //0.0000156249991
   {0x3FE02467BE553AC5LL,0xbfef976bb487403aLL,EXC_CHK_NONE},  //0.504444
   {0x3FF0000000000000LL,0x0000000000000000LL,EXC_CHK_NONE},  //1
   {0x4000000000000000LL,0x3ff0000000000000LL,EXC_CHK_NONE},  //2
   {0x3D3C25C268497682LL,0xc04597b037b2d4ccLL,EXC_CHK_NONE},  //1.0000000e-13
   {F64_POS_PI,          0x3ffa6c873f5fb93dLL,EXC_CHK_NONE},  //pi
   {0x401921FB54442D18LL,0x400536439a4c6efcLL,EXC_CHK_NONE},  //2pi
   {0x4024000000000000LL,0x400a934f0979a371LL,EXC_CHK_NONE},  //10
   {0x408F400000000000LL,0x4023ee7b471b3a95LL,EXC_CHK_NONE},  //1000
   {0x4060000000000000LL,0x401c000000000000LL,EXC_CHK_NONE},  //128
   {0x4086240000000000LL,0x4022efef7d94e785LL,EXC_CHK_NONE},  //708.5
   {0x4086280000000000LL,0x4022f074e46bc166LL,EXC_CHK_NONE},  //709
   {0x408C000000000000LL,0x40239d5d9fd5010bLL,EXC_CHK_NONE},  //896
   ...
   {0x40862e42fefa39eeLL,0x4022f14588b1f44aLL,EXC_CHK_NONE},  //7.09782712893383973096e+02   largest value  --
   {0x40862e42fefa39efLL,0x4022f14588b1f44aLL,EXC_CHK_NONE},  //7.09782712893383973096e+02   largest value
   {0x40862e42fefa39ffLL,0x4022f14588b1f44cLL,EXC_CHK_NONE},  //7.09782712893383973096e+02   overflow
   ...
   {0x3FD3333333333333LL,0xbffbca9c6f53897bLL,EXC_CHK_NONE}, // 0.3
   {0x3FE48E410B630A91LL,0xbfe46ee08c11db21LL,EXC_CHK_NONE}, // 0.642365
   {0x3FE0000000000000LL,0xbff0000000000000LL,EXC_CHK_NONE}, // 0.5
   {0x405021EB851EB852LL,0x40180c2f05577bbeLL,EXC_CHK_NONE}, // 64.53
   {0x40FF5D35B020C49CLL,0x4030f8963a17f1fbLL,EXC_CHK_NONE}, // 128467.3555
