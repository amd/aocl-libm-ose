//R.obtained=FN_PROTOTYPE(lround)(P1.input)
//double,long int,ExcFlags
//P1 R E
//unsigned long long int|double, unsigned long int|long int,ExcFlags|ExcFlags
//R.V3[j] =lround(P1.V3[j])
//double, long int, ExcFlags
//ULP amd_ref_lround_ULP(P1.V3[j],R.V3[j],&testdata[k].R.ulp[j], &testdata[k].R.relative_error[j])
//testdata[j].R.MaxUlp()
...
#ifdef WINDOWS
    {0X7ff0000000000000,0X80000000,EXC_CHK_NONE},
    {0Xfff0000000000000,0X80000000,EXC_CHK_NONE},
    {0X7ffc000000000000,0X80000000,EXC_CHK_NONE},
    {0X7ff4000000000000,0X80000000,EXC_CHK_NONE},
    {0X0,0X0,EXC_CHK_NONE},
    {0X8000000000000000,0X0,EXC_CHK_NONE},
    {0Xffefffffffffffff,0X80000000,EXC_CHK_NONE},
    {0Xc0862c4379671324,0Xfffffd3a,EXC_CHK_NONE},
    {0X3e45798ee2308c3a,0X0,EXC_CHK_NONE},
    {0X3fb999999999999a,0X0,EXC_CHK_NONE},
    {0X3fe0000000000000,0X1,EXC_CHK_NONE},
    {0X3feccccccccccccd,0X1,EXC_CHK_NONE},
    {0X3ff199999999999a,0X1,EXC_CHK_NONE},
    {0X3ff8000000000000,0X2,EXC_CHK_NONE},
    {0X3ffe666666666666,0X2,EXC_CHK_NONE},
    {0Xbe45798ee2308c3a,0X0,EXC_CHK_NONE},
    {0Xbfb999999999999a,0X0,EXC_CHK_NONE},
    {0Xbfe0000000000000,0Xffffffff,EXC_CHK_NONE},
    {0Xbfeccccccccccccd,0Xffffffff,EXC_CHK_NONE},
    {0Xbff199999999999a,0Xffffffff,EXC_CHK_NONE},
    {0Xbff8000000000000,0Xfffffffe,EXC_CHK_NONE},
    {0Xbffe666666666666,0Xfffffffe,EXC_CHK_NONE},
    {0Xbff0000000000000,0Xffffffff,EXC_CHK_NONE},
    {0X4024000000fff000,0Xa,EXC_CHK_NONE},
    {0X408f4fff00000000,0X3ea,EXC_CHK_NONE},
    {0X408f4c0000000000,0X3ea,EXC_CHK_NONE},
    {0X409003999999999a,0X401,EXC_CHK_NONE},
    {0X42cf000000000000,0x80000000,EXC_CHK_NONE},
    {0X42c80000000fffff,0x80000000,EXC_CHK_NONE},
    {0X42d10237f00fffff,0x80000000,EXC_CHK_NONE},
    {0X42e1067adfc342b0,0x80000000,EXC_CHK_NONE},
    {0X42e1067adfc34208,0x80000000,EXC_CHK_NONE},
    {0X42e800000091fabf,0x80000000,EXC_CHK_NONE},
    {0X42f8000001234fcf,0x80000000,EXC_CHK_NONE},
    {0X42f80000000cccf8,0x80000000,EXC_CHK_NONE},
    {0X43010237f0ccdfff,0x80000000,EXC_CHK_NONE},
    {0X430800056891fa02,0x80000000,EXC_CHK_NONE},
    {0X43110237f00000ff,0x80000000,EXC_CHK_NONE},
    {0X43110237f00000fe,0x80000000,EXC_CHK_NONE},
    {0X4321ffffffffffff,0x80000000,EXC_CHK_NONE},
    {0X43210237f00000ff,0x80000000,EXC_CHK_NONE},
    {0X43310237f00000ff,0x80000000,EXC_CHK_NONE},
    {0X433800056891fa00,0x80000000,EXC_CHK_NONE},
    {0X4378000000000000,0x80000000,EXC_CHK_NONE},
    {0X1,0X0,EXC_CHK_NONE},
    {0X5fde623545abc,0X0,EXC_CHK_NONE},
    {0Xfffffffffffff,0X0,EXC_CHK_NONE},
    {0X8000000000000001,0X0,EXC_CHK_NONE},
    {0X8002344ade5def12,0X0,EXC_CHK_NONE},
    {0X800fffffffffffff,0X0,EXC_CHK_NONE},
    {0X10000000000000,0X0,EXC_CHK_NONE},
    {0X8010000000000000,0X0,EXC_CHK_NONE},
    {0Xc5812e71245acfdb,0X80000000,EXC_CHK_NONE},
    {0Xffefffffffffffff,0X80000000,EXC_CHK_NONE},
    {0X7ff0000000000000,0X80000000,EXC_CHK_NONE},
    {0Xfff0000000000000,0X80000000,EXC_CHK_NONE},
    {0X7ff8000000000000,0X80000000,EXC_CHK_NONE},
    {0X7ffe1a5701234dc3,0X80000000,EXC_CHK_NONE},
    {0X7fffffffffffffff,0X80000000,EXC_CHK_NONE},
    {0Xfff8000000000000,0X80000000,EXC_CHK_NONE},
    {0Xfff8000000000001,0X80000000,EXC_CHK_NONE},
    {0Xfff9123425dcba31,0X80000000,EXC_CHK_NONE},
    {0Xffffffffffffffff,0X80000000,EXC_CHK_NONE},
    {0X7ff0000000000001,0X80000000,EXC_CHK_NONE},
    {0X7ff5344752a0bd90,0X80000000,EXC_CHK_NONE},
    {0X7ff7ffffffffffff,0X80000000,EXC_CHK_NONE},
    {0Xfff0000000000001,0X80000000,EXC_CHK_NONE},
    {0Xfff432438995fffa,0X80000000,EXC_CHK_NONE},
    {0Xfff7ffffffffffff,0X80000000,EXC_CHK_NONE},
    {0X3ff921fb54442d18,0X2,EXC_CHK_NONE},
    {0X400921fb54442d18,0X3,EXC_CHK_NONE},
    {0X401921fb54442d18,0X6,EXC_CHK_NONE},
    {0X3ffb7e151628aed3,0X2,EXC_CHK_NONE},
    {0X4005bf0a8b145769,0X3,EXC_CHK_NONE},
    {0X400dbf0a8b145769,0X4,EXC_CHK_NONE},
    {0X0,0X0,EXC_CHK_NONE},
    {0X3c4536b8b14b676c,0X0,EXC_CHK_NONE},
    {0X3fdffffbce4217d3,0X0,EXC_CHK_NONE},
    {0X3fe000000000006c,0X1,EXC_CHK_NONE},
    {0Xbbdb2752ce74ff42,0X0,EXC_CHK_NONE},
    {0Xbfdffffbce4217d3,0X0,EXC_CHK_NONE},
    {0Xbfe000000000006c,0Xffffffff,EXC_CHK_NONE},
    {0X3ff0000000000000,0X1,EXC_CHK_NONE},
    {0X3fefffffc49bd0dc,0X1,EXC_CHK_NONE},
    {0X3ff0000000000119,0X1,EXC_CHK_NONE},
    {0X3ff7fffef39085f4,0X1,EXC_CHK_NONE},
    {0X3ff8000000000001,0X2,EXC_CHK_NONE},
    {0Xbff0000000000000,0Xffffffff,EXC_CHK_NONE},
    {0Xbfefffffc49bd0dc,0Xffffffff,EXC_CHK_NONE},
    {0Xbff0000000000119,0Xffffffff,EXC_CHK_NONE},
    {0Xbff7fffef39085f4,0Xffffffff,EXC_CHK_NONE},
    {0Xbff8000000000001,0Xfffffffe,EXC_CHK_NONE},
    {0X4000000000000000,0X2,EXC_CHK_NONE},
    {0Xc000000000000000,0Xfffffffe,EXC_CHK_NONE},
    {0X4024000000000000,0Xa,EXC_CHK_NONE},
    {0Xc024000000000000,0Xfffffff6,EXC_CHK_NONE},
    {0X408f400000000000,0X3e8,EXC_CHK_NONE},
    {0Xc08f400000000000,0Xfffffc18,EXC_CHK_NONE},
    {0X4050d9999999999a,0X43,EXC_CHK_NONE},
    {0Xc050d9999999999a,0Xffffffbd,EXC_CHK_NONE},
    {0X409efe6666666666,0X7c0,EXC_CHK_NONE},
    {0Xc09efe6666666666,0Xfffff840,EXC_CHK_NONE},
    {0X4055e00000000000,0X58,EXC_CHK_NONE},
    {0Xc055e00000000000,0Xffffffa8,EXC_CHK_NONE},
    {0X41002bc800000000,0X20579,EXC_CHK_NONE},
    {0Xc1002bc800000000,0Xfffdfa87,EXC_CHK_NONE},
    {0X4330000000000000,0x80000000,EXC_CHK_NONE},
    {0X4330000000000001,0x80000000,EXC_CHK_NONE},
    {0X432fffffffffffff,0x80000000,EXC_CHK_NONE},
    {0Xc330000000000000,0X80000000,EXC_CHK_NONE},
    {0Xc330000000000001,0X80000000,EXC_CHK_NONE},
    {0Xc32fffffffffffff,0X80000000,EXC_CHK_NONE},
 ...
 * bit taken in consideration  I*/
    /*Input Num        ,The GCC output*/
    {0X43480677adfcfa00,0X80000000,EXC_CHK_NONE},
    {0X435801239871fa00,0x80000000,EXC_CHK_NONE},
    {0X4368111144444444,0x80000000,EXC_CHK_NONE},
    {0X4388ffffffffffff,0x80000000,EXC_CHK_NONE},
    {0X4398ffffffffffff,0x80000000,EXC_CHK_NONE},
    {0X43a8ffffffffffff,0x80000000,EXC_CHK_NONE},
    {0X43b8aaaa68ffffff,0x80000000,EXC_CHK_NONE},
    {0X43c8aaaa69ffffff,0x80000000,EXC_CHK_NONE},
    {0X43d8009678abcd00,0x80000000,EXC_CHK_NONE},
    {0X7fefffffffffffff,0x80000000,EXC_CHK_NONE},
    {0X43e8098734209870,0x80000000,EXC_CHK_NONE},
    {0X43f800876abcda00,0x80000000,EXC_CHK_NONE},
    {0X44080091781cdba0,0x80000000,EXC_CHK_NONE},
    {0X4408012786abcde0,0x80000000,EXC_CHK_NONE},
    {0X43b3c4eafedcab02,0x80000000,EXC_CHK_NONE}
