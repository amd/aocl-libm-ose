//R.obtained=FN_PROTOTYPE(remainderf)(P1.input, P2.input)
...
//float float float ExcFlags
//ULP amd_ref_remainderf_ULP(P1.V3[j],P2.V3[j],R.V3[j],&testdata[k].R.ulp[j], &testdata[k].R.relative_error[j])
//testdata[j].R.MaxUlp()

static struct data input[] =
{
        {0xffdbc0b7,0x8367e3b0,0x7fc00001,EXC_CHK_NONE},        
    ...
    {F32_NEG_INF,F32_NEG_QNAN,F32_POS_QNAN,EXC_CHK_INVL}, //input x is inf
    ...
    {F32_POS_LDENORM,F32_POS_HDENORM,0x00000001,EXC_CHK_UNFL},
    {F32_POS_LDENORM,F32_NEG_HDENORM,0x00000001,EXC_CHK_UNFL},
    {F32_POS_LDENORM,F32_POS_LDENORM,0x00000000,EXC_CHK_NONE},
    {F32_POS_LDENORM,F32_NEG_LDENORM,0x00000000,EXC_CHK_NONE},

    {F32_POS_HDENORM,F32_POS_LNORMAL,0x80000001,EXC_CHK_UNFL},
    {F32_POS_LDENORM,F32_NEG_HNORMAL,0x00000001,EXC_CHK_UNFL}, /*Confirm this exception*/
    {F32_NEG_HNORMAL,F32_POS_LDENORM,0x80000000,EXC_CHK_NONE},
    {F32_POS_LNORMAL,F32_NEG_HDENORM,0x00000001,EXC_CHK_UNFL},
    {F32_POS_HDENORM,F32_POS_ONE,0x007fffff,EXC_CHK_UNFL},
    {F32_POS_LDENORM,F32_NEG_ONE,0x00000001,EXC_CHK_UNFL},
