//R.obtained=FN_PROTOTYPE(rintf)(P1.input)
...
{0x80000001,0x80000000,EXC_CHK_NONE},  // -denormal min
{0x805def12,0x80000000,EXC_CHK_NONE},  // -denormal intermediate
{0x807FFFFF,0x80000000,EXC_CHK_NONE},  // -denormal max
{0x00800000,0x3f800000,EXC_CHK_NONE},  // normal min
{0x43b3c4ea,0x43b40000,EXC_CHK_NONE},  // normal intermediate
{0x7f7fffff,0x7f7fffff,EXC_CHK_NONE},  // normal max
{0x80800000,0x80000000,EXC_CHK_NONE},  // -normal min
{0xc5812e71,0xc5812800,EXC_CHK_NONE},  // -normal intermediate
...
{0x3FC90FDB,0x40000000,EXC_CHK_NONE},  // pi/2
{0x40490FDB,0x40800000,EXC_CHK_NONE},  // pi
{0x40C90FDB,0x40e00000,EXC_CHK_NONE},  // 2pi
{0x402DF853,0x40400000,EXC_CHK_NONE},  // e --
{0x402DF854,0x40400000,EXC_CHK_NONE},  // e
{0x402DF855,0x40400000,EXC_CHK_NONE},  // e ++
{0x00000000,0x00000000,EXC_CHK_NONE},  // 0
{0x37C0F01F,0x3f800000,EXC_CHK_NONE},  // 0.000023
{0x3EFFFEB0,0x3f800000,EXC_CHK_NONE},  // 0.49999
{0x3F0000C9,0x3f800000,EXC_CHK_NONE},  // 0.500012
{0x80000000,0x80000000,EXC_CHK_NONE},  // -0
{0xb7C0F01F,0x80000000,EXC_CHK_NONE},  // -0.000023
{0xbEFFFEB0,0x80000000,EXC_CHK_NONE},  // -0.49999
{0xbF0000C9,0x80000000,EXC_CHK_NONE},  // -0.500012
{0x3f800000,0x3f800000,EXC_CHK_NONE},  // 1
{0x3f700001,0x3f800000,EXC_CHK_NONE},  // 0.93750006
{0x3F87FFFE,0x40000000,EXC_CHK_NONE},  // 1.0624998
{0x3FBFFFAC,0x40000000,EXC_CHK_NONE},  // 1.49999
{0x3FC00064,0x40000000,EXC_CHK_NONE},  // 1.500012
{0xbf800000,0xbf800000,EXC_CHK_NONE},  // -1
{0xbf700001,0x80000000,EXC_CHK_NONE},  // -0.93750006
{0xbF87FFFE,0xbf800000,EXC_CHK_NONE},  // -1.0624998
{0xbFBFFFAC,0xbf800000,EXC_CHK_NONE},  // -1.49999
{0xbFC00064,0xbf800000,EXC_CHK_NONE},  // -1.500012
...
{0x4286CCCC,0x42880000,EXC_CHK_NONE},  // 67.4
{0xc286CCCC,0xc2860000,EXC_CHK_NONE},  // -67.4
{0x44F7F333,0x44f80000,EXC_CHK_NONE},  // 1983.6
{0xc4F7F333,0xc4f7e000,EXC_CHK_NONE},  // -1983.6
{0x42AF0000,0x42b00000,EXC_CHK_NONE},  // 87.5
{0xc2AF0000,0xc2ae0000,EXC_CHK_NONE},  // -87.5
...
{0x4AFFFFFF,0x4b000000,EXC_CHK_NONE},  // 2^23 -1 + 0.5
{0xcB000000,0xcb000000,EXC_CHK_NONE},  // -2^23
{0xcB000001,0xcb000001,EXC_CHK_NONE},  // -(2^23 + 1)
{0xcAFFFFFF,0xcafffffe,EXC_CHK_NONE}   // -(2^23 -1 + 0.5)
