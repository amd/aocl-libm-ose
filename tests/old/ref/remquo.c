...
#if defined(FLOAT)
#define FUNC_REMQUO amd_ref_remquof
#define FUNC_REMQUO_ULP amd_ref_remquof_ULP
#elif defined(DOUBLE)
#define FUNC_REMQUO amd_ref_remquo
#define FUNC_REMQUO_ULP amd_ref_remquo_ULP
#else
#error
#endif
