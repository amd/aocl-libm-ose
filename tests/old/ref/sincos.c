...
#if defined(FLOAT)
#define FUNC_SINCOS amd_ref_sincosf
#define FUNC_SINCOS_ULP amd_ref_sincosf_ULP
#elif defined(DOUBLE)
#define FUNC_SINCOS amd_ref_sincos
#define FUNC_SINCOS_ULP amd_ref_sincos_ULP
#else
#error
#endif
