...
class UnitTestData {
  public: Timer timer;
    ...
    Run() {
        ...
        timer.Start(); R.obtained = FN_PROTOTYPE(hypot)(P1.input, P2.input);
        timer.Sample();
    }
};
void
RangeTest() {
    ...
    TestReport::Header("hypot_rand.txt", 0);
    TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(hypot)(P1.input, P2.input)    R.V3[j] = amd_ref_hypot(P1.V3[j],P2.V3[j])");
