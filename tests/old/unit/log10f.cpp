...
class UnitTestData {
  public: Timer timer;
    ...
    Run() {
        ...
        timer.Start(); R.obtained = FN_PROTOTYPE(log10f)(P1.input); timer.Sample();
    }
};
void
RangeTest() {
    ...
    TestReport::Header("log10f_rand.txt", 0);
    TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(log10f)(P1.input)    R.V3[j] = amd_ref_log10f(P1.V3[j])");
