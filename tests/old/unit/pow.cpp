...
class UnitTestData {
  public: Timer timer;
    ...
    Run() {
        ...
        timer.Start(); R.obtained = FN_PROTOTYPE(pow)(P1.input, P2.input);
        timer.Sample();
    }
};
void
RangeTest() {
    ...
    TestReport::Header("pow_rand.txt", 0);
    TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(pow)(P1.input, P2.input)    R.V3[j] = amd_ref_pow(P1.V3[j],P2.V3[j])");
