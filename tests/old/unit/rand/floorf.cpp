...
class UnitTestData {
  public: Timer timer;
    ...
    Run() {
        ...
        timer.Start(); R.obtained = FN_PROTOTYPE(floorf)(P1.input); timer.Sample();
    }
};
void
RandomTest(int size, int seed) {
    ...
    TestReport::Header("floorf_rand.txt", seed);
    TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(floorf)(P1.input)    R.V3[j] = floorf(P1.V3[j])");
