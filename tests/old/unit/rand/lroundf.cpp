...
class UnitTestData {
  public: Timer timer;
    ...
    Run() {
        ...
        timer.Start(); R.obtained = FN_PROTOTYPE(lroundf)(P1.input); timer.Sample();
    }
};
void
RandomTest(int size, int seed) {
    ...
    TestReport::Header("lroundf_rand.txt", seed);
    TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(lroundf)(P1.input)    R.V3[j] = lroundf(P1.V3[j])");
