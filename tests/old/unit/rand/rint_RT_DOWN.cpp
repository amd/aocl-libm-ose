...
class UnitTestData {
  public: Timer timer;
    ...
    Run() {
        ...
        timer.Start(); R.obtained = FN_PROTOTYPE(rint)(P1.input); timer.Sample();
    }
};
void
RandomTest(int size, int seed) {
    ...
    TestReport::Header("rint_RT_DOWN_rand.txt", seed);
    TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(rint)(P1.input)    R.V3[j] = rint(P1.V3[j])");
