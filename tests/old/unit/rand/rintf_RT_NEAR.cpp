...
RandomTest(int size, int seed) {
    ...
    TestReport::Header("rintf_RT_NEAR_rand.txt", seed);
    TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(rintf)(P1.input)    R.V3[j] = rintf(P1.V3[j])");
