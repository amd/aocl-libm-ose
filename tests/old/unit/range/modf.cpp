...
class UnitTestData {
  public: Timer timer;
    ...
    Run() {
        ...
        timer.Start(); R.obtained = FN_PROTOTYPE(modf)(P1.input, &P2.obtained);
        timer.Sample();
    }
};
void
RangeTest() {
    ...
    TestReport::Header("modf_rand.txt", 0);
    TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(modf)(P1.input, &P2.obtained)    R.V3[j] = amd_ref_modf(P1.V3[j],&P2.V3[j])");
