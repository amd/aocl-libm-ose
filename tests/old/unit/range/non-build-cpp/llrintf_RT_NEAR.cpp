...
#include "unit/llrintf_RT_NEAR.h"
#include "FunHed.h"
...
class UnitTestData {
  public: Timer timer;
    ...
    Run() {
        ...
        timer.Start(); R.obtained = FN_PROTOTYPE(llrintf)(P1.input); timer.Sample();
    }
};
void
RangeTest() {
    ...
    TestReport::Header("llrintf_RT_NEAR_rand.txt", 0);
    TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(llrintf)(P1.input)    R.V3[j] = llrintf(P1.V3[j])");
