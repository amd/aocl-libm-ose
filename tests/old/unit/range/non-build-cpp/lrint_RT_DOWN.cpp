...
class UnitTestData {
  public: Timer timer;
    ...
    Run() {
        ...
        timer.Start(); R.obtained = FN_PROTOTYPE(lrint)(P1.input); timer.Sample();
    }
};
void
RangeTest() {
    ...
    TestReport::Header("lrint_RT_DOWN_rand.txt", 0);
    TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(lrint)(P1.input)    R.V3[j] = lrint(P1.V3[j])");
