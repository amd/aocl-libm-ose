...
class UnitTestData {
  public: Timer timer;
    ...
    Run() {
        ...
        timer.Start(); FN_PROTOTYPE(sincosf)(P1.input, &P2.obtained, &P3.obtained);
        timer.Sample();
    }
};
void
RangeTest() {
    ...
    TestReport::Header("sincosf_rand.txt", 0);
    TestReport::FuncHeader("FN_PROTOTYPE(sincosf)(P1.input, &P2.obtained, &P3.obtained)    amd_ref_sincosf(P1.V3[j],&P2.V3[j],&P3.V3[j])");
