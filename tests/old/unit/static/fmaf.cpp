...
timer.Start();R.obtained=FN_PROTOTYPE(fmaf)(P1.input, P2.input, P3.input);timer.Sample();}};
int main(){
...
TestReport::Header("fmaf.txt");
TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(fmaf)(P1.input, P2.input, P3.input)");
for(int j=0; j<k ; j++ ){
testdata[j].Report();
}
TestReport::Footer();
