...
timer.Start();R.obtained=FN_PROTOTYPE(fmax)(P1.input, P2.input);timer.Sample();}};
int main(){
...
TestReport::Header("fmax.txt");
TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(fmax)(P1.input, P2.input)");
for(int j=0; j<k ; j++ ){
testdata[j].Report();
}
TestReport::Footer();
