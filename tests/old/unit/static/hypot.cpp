...
timer.Start();R.obtained=FN_PROTOTYPE(hypot)(P1.input, P2.input);timer.Sample();}};
int main(){
...
TestReport::Header("hypot.txt");
TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(hypot)(P1.input, P2.input)");
for(int j=0; j<k ; j++ ){
testdata[j].Report();
}
TestReport::Footer();
