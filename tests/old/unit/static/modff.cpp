...
timer.Start();R.obtained=FN_PROTOTYPE(modff)(P1.input, &P2.obtained);timer.Sample();}};
int main(){
...
TestReport::Header("modff.txt");
TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(modff)(P1.input, &P2.obtained)");
for(int j=0; j<k ; j++ ){
testdata[j].Report();
}
TestReport::Footer();
