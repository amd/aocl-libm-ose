...
timer.Start();R.obtained=FN_PROTOTYPE(remainder)(P1.input, P2.input);timer.Sample();}};
int main(){
...
TestReport::Header("remainder.txt");
TestReport::FuncHeader("R.obtained=FN_PROTOTYPE(remainder)(P1.input, P2.input)");
for(int j=0; j<k ; j++ ){
testdata[j].Report();
}
TestReport::Footer();
