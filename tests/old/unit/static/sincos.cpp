...
timer.Start();FN_PROTOTYPE(sincos)(P1.input, &P2.obtained, &P3.obtained);timer.Sample();}};
int main(){
...
TestReport::Header("sincos.txt");
TestReport::FuncHeader("FN_PROTOTYPE(sincos)(P1.input, &P2.obtained, &P3.obtained)");
for(int j=0; j<k ; j++ ){
testdata[j].Report();
}
TestReport::Footer();
