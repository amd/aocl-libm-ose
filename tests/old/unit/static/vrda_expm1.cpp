...
timer.Start();FN_PROTOTYPE(vrda_expm1)(len.input,src.obtained,dst.obtained);timer.Sample();}};
int main(){
...
testdata.SetName();
testdata.Run();
TestReport::Header("vrda_expm1.txt");
TestReport::FuncHeader("FN_PROTOTYPE(vrda_expm1)(len.input,src.obtained,dst.obtained)");
testdata.Report();
TestReport::Footer();
