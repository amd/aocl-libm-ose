...
timer.Start();FN_PROTOTYPE(vrs4_sincosf)(P1.input, &P2.obtained, &P3.obtained);timer.Sample();}};
int main(){
...
TestReport::Header("vrs4_sincosf.txt");
TestReport::FuncHeader("FN_PROTOTYPE(vrs4_sincosf)(P1.input, &P2.obtained, &P3.obtained)");
for(int j=0; j<k ; j++ ){
testdata[j].Report();
}
TestReport::Footer();
