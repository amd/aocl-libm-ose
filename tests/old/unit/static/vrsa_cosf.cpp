...
timer.Start();FN_PROTOTYPE(vrsa_cosf)(len.input,src.obtained,dst.obtained);timer.Sample();}};
int main(){
...
testdata.SetName();
testdata.Run();
TestReport::Header("vrsa_cosf.txt");
TestReport::FuncHeader("FN_PROTOTYPE(vrsa_cosf)(len.input,src.obtained,dst.obtained)");
testdata.Report();
TestReport::Footer();
