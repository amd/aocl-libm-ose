...
timer.Start();FN_PROTOTYPE(vrsa_expm1f)(len.input,src.obtained,dst.obtained);timer.Sample();}};
int main(){
...
testdata.SetName();
testdata.Run();
TestReport::Header("vrsa_expm1f.txt");
TestReport::FuncHeader("FN_PROTOTYPE(vrsa_expm1f)(len.input,src.obtained,dst.obtained)");
testdata.Report();
TestReport::Footer();
