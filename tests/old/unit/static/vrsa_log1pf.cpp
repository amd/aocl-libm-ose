...
timer.Start();FN_PROTOTYPE(vrsa_log1pf)(len.input,src.obtained,dst.obtained);timer.Sample();}};
int main(){
...
testdata.SetName();
testdata.Run();
TestReport::Header("vrsa_log1pf.txt");
TestReport::FuncHeader("FN_PROTOTYPE(vrsa_log1pf)(len.input,src.obtained,dst.obtained)");
testdata.Report();
TestReport::Footer();
