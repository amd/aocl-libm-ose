...
timer.Start();FN_PROTOTYPE(vrsa_logf)(len.input,src.obtained,dst.obtained);timer.Sample();}};
int main(){
...
testdata.SetName();
testdata.Run();
TestReport::Header("vrsa_logf.txt");
TestReport::FuncHeader("FN_PROTOTYPE(vrsa_logf)(len.input,src.obtained,dst.obtained)");
testdata.Report();
TestReport::Footer();
