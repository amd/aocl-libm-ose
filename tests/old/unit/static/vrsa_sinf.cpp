...
timer.Start();FN_PROTOTYPE(vrsa_sinf)(len.input,src.obtained,dst.obtained);timer.Sample();}};
int main(){
...
testdata.SetName();
testdata.Run();
TestReport::Header("vrsa_sinf.txt");
TestReport::FuncHeader("FN_PROTOTYPE(vrsa_sinf)(len.input,src.obtained,dst.obtained)");
testdata.Report();
TestReport::Footer();
